inherited frmISUsers: TfrmISUsers
  Left = 81
  Top = 124
  Caption = #1055#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1080' '#1048#1085#1092#1086#1088#1084#1072#1094#1080#1086#1085#1085#1099#1093' '#1057#1077#1088#1074#1080#1089#1086#1074
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited fibdsMainList: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'where (S.ID=C.SERVICE_ID) and (S.SERVICE_KIND=1)')
    ...
    object fibdsMainListSERVICE_ID: TFIBIntegerField
      DisplayLabel = #1048#1085#1092#1086#1088#1084#1072#1094#1080#1086#1085#1085#1099#1081' '#1089#1077#1088#1074#1080#1089
